...
def predict():
    if request.method == "POST":
        ...
        Month_of_Journey = int(pd.to_datetime(date_dep, format="%Y-%m-%dT%H:%M").day)
        # print("Journey Date : ",Day of Journey, Month of Journey)
       ...
       # Departure
        ...
        # print("Departure : ",Departure hour, Departure min)
    
        # Arrival
        date_arr = request.form["Arrival_Time"]
        Arrival_hour = int(pd.to_datetime(date_arr, format ="%Y-%m-%dT%H:%M").hour)
        Arrival_min = int(pd.to_datetime(date_arr, format ="%Y-%m-%dT%H:%M").minute)
        # print("Arrival : ", Arrival hour, Arrival min)
